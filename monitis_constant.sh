...
declare -r APIKEY="T5BAQ.......FE28OSSQ"		# ApiKey - REPLACE it by your key's value (can be obtained from your Monitis account)
declare -r SECRETKEY="248VU.....31A9U6D9OHT"	# SecretKey - REPLACE it by your key's value (can be obtained from your Monitis account)
